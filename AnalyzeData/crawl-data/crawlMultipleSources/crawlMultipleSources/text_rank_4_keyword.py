...
class TextRank4Keyword:
	...
	def analyze(self, text, candidate_post=['NOUN', 'PROPN'],
...
# text = """Describe your solution to the problem
# CONSEGUIR APOYO A LA RED CARDANO MEDIANTE POOLS DE STAKING
# Relevant experience
# LOTERIA DE CARDANO
# Detailed plan (not required) - Fill in here any additional details
# UN POOL DE CARDANO DONDE LOS USUARIOS A PARTE DE HACER STAKING, PARTICIPAN EN UN SORTEO SEMANAL O MENSUAL. DONDE LOS INTERESES GENERADOS POR ESE POOL SON SORTEADOS ENTRE LOS PARTICIPANTES.
# EL OPERADOR DEL POOL, RECIBIRÁ LAS COMISIONES CORRESPONDIENTES PARA SU MANTENIMIENTO.
# CUALQUIER USUARIO DEBE PODER CREAR UN POOL DENTRO DE LA COMUNIDAD I PODER GESTIONARLO ."""
